...
The [Indo-Pacific]({{ site.baseurl }}/regions/indo-pacific.html) theater is increasingly interconnected with other theaters of great power competition, as described in the [Cold War 2.0]({{ site.baseurl }}/conflicts/cold-war-2.html) framework.
...
[Velina Tchakarova]({{ site.baseurl }}/actors/authors/velina-tchakarova.html) identifies a consequential development: three major NATO members — [Britain]({{ site.baseurl }}/actors/countries/france.html), [France]({{ site.baseurl }}/actors/countries/france.html), and [Germany]({{ site.baseurl }}/actors/countries/germany.html) — issued a coordinated statement on the Pacific maritime dispute [1]. This represents European powers now treating Taiwan as integral to the global order and extending their deterrence posture into the Pacific, beyond the traditional Euro-Atlantic focus of NATO [1]. The statement signals that the defense of Taiwan is no longer framed solely as a US commitment but as a broader Western interest.

## Grey-Zone Strategy

Tchakarova describes the comprehensive campaign as a combination of military encirclement, grey-zone harassment, economic inducement, espionage, and united-front messaging — all working in concert to erode Taiwan's defensive will [1]. Environmental conservation is being used as a pretext for territorial claims, with China converting one-time survey deployments into recurring presence, thereby establishing facts on the water that normalize Chinese authority [1].
...
Each iteration of these exercises improves the PLA's ability to execute a real blockade. The exercise served coercive psychological warfare purposes aimed at intimidating Taiwan's DPP government and deterring [Japan]({{ site.baseurl }}/actors/countries/japan.html) from supporting Taiwan [4].
