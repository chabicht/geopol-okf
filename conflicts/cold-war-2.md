...
## The DragonBear Axis: Coordination Without Alliance

The DragonBear axis — Tchakarova's term for the deepening coordination between China and Russia — emerged from the Iran war more operationally coordinated but more visibly hierarchical [1]. China is expanding yuan settlement, CIPS throughput, and sanctions-resistant energy infrastructure, while Russia has become more dependent on Chinese pricing power and market access. The asymmetry within the axis is sharpening: China provides the economic architecture, Russia provides the military disruption, and the dependency flows one way [1].

The persistent Western analytical error, Tchakarova argues, is treating each China-Russia joint exercise, arms transfer, or summit communiqué as a discrete event and then asking "are they allies yet?" This framing misreads what is being built. The DragonBear does not describe an alliance but a strategic coordination across all systemically relevant domains: maritime, informational, technological, strategic, and increasingly experiential. The partnership does not need the formal architecture of alliance to reshape the balance of power. The correct question is not whether Beijing and Moscow are strategic allies, but whether the DragonBear needs to be one to reshape the global balance of power. Tchakarova's answer is clear: it does not — and that is what makes the relationship increasingly dangerous and unpredictable [8].

July 2026 offered a concentrated illustration of the axis's reach and its one hard boundary. The coordination operates across all systemically relevant domains simultaneously — that simultaneity is the signature [8]:
...
The operational logic beneath this coordination is bandwidth exploitation. Contesting [Taiwan]({{ site.baseurl }}/conflicts/taiwan-standoff.html)'s maritime approaches while Moscow ties down Western attention in [Ukraine]({{ site.baseurl }}/conflicts/russia-ukraine-war.html) exemplifies coordinated pressure within the DragonBear framework: China stretches Taiwan, [Japan]({{ site.baseurl }}/actors/countries/japan.html), and the Philippines across simultaneous theaters, forcing each to allocate finite attention against multiple vectors of pressure [9]. The framework is developed below in [Systemic Competition & the Bandwidth Exploit](#systemic-competition--the-bandwidth-exploit).

The axis's coordination extends to great-power bargaining. [Phillips O'Brien]({{ site.baseurl }}/actors/authors/phillips-obrien.html) reports that China is treating Taiwan as a "chip" in the broader Iran negotiation — backing [Iran]({{ site.baseurl }}/actors/countries/iran.html) while signaling that Taiwan's status is part of the great power bargain, not an isolated territorial question [10]. The [CMC purge]({{ site.baseurl }}/events/cmc-purge-2026.html) and China's coercive campaign against Taiwan are thus components of a single negotiating posture: military pressure on the island is held in reserve as leverage across theaters.

## Systemic Competition & the Bandwidth Exploit

As of mid-2026, the base case is "Hot Peace and Cold War": multipolar diplomacy operating inside increasingly bifurcated financial, technological, industrial, and security systems [1]. Washington and Beijing preserved the headline trade truce while escalating through blacklists, export controls, procurement bans, biotech restrictions, robotics, and rare-earth chokepoints. Full Cold War 2.0 escalation is now the second-most-probable configuration at approximately 27% probability. The decisive variable is the sixty-day Iran Memorandum window, which expires in mid-August — if it holds, the system gains time but not stability; if it fails, Hormuz, Lebanon, Ukraine, Taiwan, and critical minerals can reactivate together within hours [1].

Tchakarova argues that the DragonBear axis is engineered to exploit Western bandwidth limitations — the structural inability of the US and its allies to sustain high-level engagement across more than two or three theaters simultaneously [1]. The axis does not need to win any single theater; it needs to create enough pressure across enough theaters to force the West to allocate suboptimally everywhere. The Iran war demonstrated this logic in practice: the same US munitions, air-defense inventories, political attention, and industrial bottlenecks recurred across the Middle East, Ukraine, and the Indo-Pacific simultaneously [1]. The axis is not static — Tchakarova identifies a deepening operational coordination beneath the trade truce, where blacklists, export controls, procurement bans, biotech restrictions, robotics, and rare-earth chokepoints are all active vectors of Cold War 2.0 escalation even as headline diplomacy continues. The "Hot Peace" base case means that the competition has moved below the threshold of overt confrontation but is intensifying across every systemic domain [1].

Latin America's rightward turn is, in Tchakarova's framing, a theater in the contest for spheres of influence — not an autonomous regional phenomenon but a front in the global competition [2]. For the DragonBear, consolidation in Latin America closes a flank that the West has historically assumed was secure, forcing Washington to divert resources from other theaters to defend its hemisphere [2].
...
## Capital as a Domain of Competition

Hamlet Yousef ([The Cipher Brief]({{ site.baseurl }}/actors/authors/the-cipher-brief.html)) argues that Cold War 2.0 is not coming — it is already here, and much of the real competition is taking place through capital markets, technology, [critical minerals]({{ site.baseurl }}/themes/critical-minerals.html), supply chains, ports, telecommunications, manufacturing, energy, intellectual property, and information. Much of the modern battlefield now sits in the private sector. [China]({{ site.baseurl }}/actors/countries/china.html) understood this years ago: the CCP does not separate commercial activity from national strategy the way the West often does — Beijing treats finance, industry, technology, diplomacy, intelligence, media, and military power as parts of the same system. The Belt and Road Initiative is the clearest example: usually described as an infrastructure and development program, it also combines state-backed financing, ports, telecommunications, mining rights, construction, energy, logistics, commodity access, and political/media influence. A port is not just a port when it sits on a critical trade route; a telecom network is not merely commercial infrastructure when it carries government and economic data; a mine is not just a commodity asset when it controls access to materials needed for semiconductors, weapons, batteries, and advanced manufacturing. Beijing understands that capital can create strategic leverage without firing a shot — locking up supply chains, shaping political decisions, creating economic dependencies, and establishing long-term access [11].

The Western answer, in Yousef's framing, should not be a watered-down version of Chinese state capitalism but the mobilization of what authoritarian systems struggle to replicate: deep, innovative, risk-tolerant capital markets. The next phase is not just building new companies but acquiring, recapitalizing, modernizing, and scaling strategic assets that already exist — mines, processing facilities, ports, defense suppliers, energy infrastructure, semiconductor capacity, logistics networks, telecommunications, and advanced manufacturing, including autonomous shipbuilding capabilities. The historical precedent is the Letter of Marque: Congress once authorized privately financed vessels to capture enemy shipping under a legal framework established by government. The modern equivalent would be financial, legal, and commercial — tax-advantaged national-security funds, political-risk insurance, export-credit support, allied co-investment vehicles, faster regulatory review for strategic acquisitions, purchasing commitments, and carefully managed threat briefings for vetted investors. Government sets the conditions; private capital finds the opportunity, performs the diligence, assumes the risk, improves the asset, and earns the return. The fiscal argument matters: every strategic capability financed primarily by private investors is one less burden placed entirely on the federal balance sheet. The Americas should be the first major test — see [Latin America]({{ site.baseurl }}/regions/latin-america.html). Capital is not simply financing the arsenal anymore; capital is becoming the arsenal [11]. See [Great Power Competition]({{ site.baseurl }}/themes/great-power-competition.html) for the framework-level treatment and [Sanctions and Financial Warfare]({{ site.baseurl }}/themes/sanctions-and-financial-warfare.html) for the coercive-financial dimension.
