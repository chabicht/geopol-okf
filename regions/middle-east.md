...
The region hosts a dense web of competing actors — the United States, Iran, Israel, the Gulf monarchies, Russia, and China — each pursuing divergent interests across military, energy, and ideological domains. See [United States]({{ site.baseurl }}/actors/countries/united-states.html), [Iran]({{ site.baseurl }}/actors/countries/iran.html), and [Israel]({{ site.baseurl }}/actors/countries/israel.html) for actor-specific detail.

# Current Situation

- The [US-Iran War of 2026]({{ site.baseurl }}/conflicts/us-iran-war-2026.html) disrupted Hormuz traffic; approximately 10 million barrels per day were lost against a 20 mbpd baseline.
- The [June 17 Versailles MoU]({{ site.baseurl }}/events/iran-ceasefire-mou.html) ended the kinetic phase, but it represents a managed pause, not structural recovery.
- Iran retained leverage over Hormuz passage, including the ability to charge fees and control inspections.
- The [Qatar Ras Laffan LNG explosion]({{ site.baseurl }}/events/qatar-lng-explosion.html) compounded regional energy vulnerability, exposing the concentration of global LNG supply in a single complex. See [Qatar]({{ site.baseurl }}/actors/countries/qatar.html).
...
- [Saudi Arabia]({{ site.baseurl }}/actors/countries/saudi-arabia.html) conducted secret negotiations with Iran through [Pakistan]({{ site.baseurl }}/actors/countries/pakistan.html), with Russian and Chinese support, aiming at a non-aggression pact — signaling the end of the US monopoly on Middle East security architecture [4].
- [Oman]({{ site.baseurl }}/actors/countries/oman.html) co-negotiated a permanent [toll system]({{ site.baseurl }}/events/hormuz-toll-system.html) for Hormuz with Iran, formalizing Iran's chokepoint leverage [5].
- The [UAE]({{ site.baseurl }}/actors/countries/uae.html) requested a US dollar swap line during the war, signaling stress in the petrodollar system while simultaneously facilitating Chinese-Iranian oil trade [6].
- The US is transitioning from a bilateral, [Israel]({{ site.baseurl }}/actors/countries/israel.html)-centric security framework to a multilateral, partnership-driven approach. The "Board of Peace" — with [Turkey]({{ site.baseurl }}/actors/countries/turkey.html), [Saudi Arabia]({{ site.baseurl }}/actors/countries/saudi-arabia.html), Egypt, Jordan, Indonesia, [Pakistan]({{ site.baseurl }}/actors/countries/pakistan.html), [Qatar]({{ site.baseurl }}/actors/countries/qatar.html), and the UAE participating — represents the new architecture [7].
...
[16] [Outgunned, But Not Outplayed: Iran's Theory of Victory](https://warontherocks.com/outgunned-but-not-outplayed-irans-theory-of-victory/)
