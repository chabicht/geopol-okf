...
Along with [NATO]({{ site.baseurl }}/actors/organizations/nato.html), the EU is part of the Western alliance architecture under strain from the [United States]({{ site.baseurl }}/actors/countries/united-states.html) shifting priorities. The [global system rupture]({{ site.baseurl }}/themes/global-system-rupture.html) is not merely external pressure — it is testing the internal coherence of the EU itself, as member states diverge in their threat perceptions, energy strategies, and willingness to bear the costs of strategic autonomy.
...
2. **Like-minded NATO partners beyond the EU**: Canada and the [United Kingdom]({{ site.baseurl }}/actors/countries/united-kingdom.html). The UK SDP marked a turning point in the post-Brexit relationship; Canada's reflects its pursuit of middle-power partnerships amid US uncertainty.
3. **Global partners**: [Japan]({{ site.baseurl }}/actors/countries/japan.html), South Korea, [Australia]({{ site.baseurl }}/actors/countries/australia.html), [India]({{ site.baseurl }}/actors/countries/india.html), Ghana. The Indo-Pacific focus is clear. India stands out as a traditional non-aligned country with a continuing Russian defence-industrial relationship.

Notably absent: the United States, [China]({{ site.baseurl }}/actors/countries/china.html), Turkey (blocked by Cyprus conflict), and most of South/Central America and South Africa [5].
