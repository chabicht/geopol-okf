...
Adam Tooze is an economic historian and author of the Chartbook newsletter on Substack. His work provides macroeconomic and political-economy analysis of the global system, with particular attention to the intersection of trade, finance, industrial policy, and geopolitics. He frames contemporary economic dynamics within longer historical arcs, connecting sectoral shifts to macroeconomic aggregates and back to political economy.

# Key Frameworks

## China Shock 2.0

Tooze adapts Brad Setser's "China Shock 2.0" thesis to argue that the current wave of Chinese export competition differs fundamentally from the early-2000s "China Shock 1.0." The first shock was a cost-of-production story focused on low-tech sectors and felt primarily in the US. China Shock 2.0 is above all about [Europe]({{ site.baseurl }}/regions/europe.html) and about China's progress up the industrial value chain — concentrated in a cluster of sectors, above all vehicles. 60% of the €27 billion swing in [Germany]({{ site.baseurl }}/actors/countries/germany.html)'s trade balance with China between 2021 and 2025 is accounted for by cars. The shock is "mercantilist-on-mercantilist violence": Germany is itself a chronic trade surplus country, so the dynamic is competitive surplus against surplus, not the classic deficit-country-versus-surplus-country story [1].
...
## The Real Exchange Rate and Financial Repression

Tooze argues that China's real exchange rate is actually depreciating, making Chinese goods even more competitive. Since 2021, prices in the West have risen while China hovers on the edge of deflation; with the nominal exchange rate pegged by capital controls and intervention at an undervalued rate, the effect is real depreciation. The proceeds from huge trade surpluses are absorbed into official and quasi-official reserve accumulation rather than driving yuan appreciation [1][2].

The other side of exchange rate management is capital controls that wall in tens of trillions in Chinese wealth. Tooze frames this as "financial repression" — a core component of China's political economy. Beijing tolerates national wealth creation but does not grant its bourgeoisie unlimited free disposal of its wealth. The crackdown on offshore brokerage accounts (Longbridge, Tiger Brokers, Futu fined $330M), restrictions on red-chip IPO structures, and aggressive tax enforcement against wealthy individuals are all mechanisms to prevent capital flight. An estimated $800 billion to $1 trillion left China in 2025, triggering Beijing's crackdown [2].

The paradox: those calling for yuan revaluation to address China Shock 2.0 do not suggest China should liberalize its balance of payments. The proposal is to maintain the control system but push the currency up — which would require *more* financial repression, not less, as Beijing would need to tighten its grip on capital outflows to counter downward pressure. Calling for revaluation without discussing financial repression is, in Tooze's framing, a euphemism [2].

## The AI Boom and the Gilded Cage

Tooze identifies the US AI boom as a "K-shaped expansion" rippling across the world economy. The boom is sucking in imports — but from [Taiwan]({{ site.baseurl }}/actors/countries/taiwan.html) and Mexico, not from China. The bilateral US-China trade truce is holding; the bilateral deficit has narrowed dramatically. The US has effectively excluded the leading edge of China's export drive (100% tariffs on Chinese EVs), making China Shock 2.0 largely a China-Europe problem rather than a China-US one [2].
...
Tooze identifies four disrupters operating simultaneously [1]:
