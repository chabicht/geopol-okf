...
The Royal United Services Institute (RUSI) is the world's oldest defense and security think tank, founded in 1831 in London. RUSI produces research and commentary across the full spectrum of defense, security, and international affairs, with particular depth in [NATO]({{ site.baseurl }}/actors/organizations/nato.html) strategy, [defense industrial resilience]({{ site.baseurl }}/themes/defense-industrial-resilience.html), [sanctions and financial warfare]({{ site.baseurl }}/themes/sanctions-and-financial-warfare.html), asymmetric warfare, and Indo-Pacific security partnerships. Its current Director-General is Rachel Ellehuus.

RUSI analysis is characterized by practitioner-oriented rigor: bridging policy, operational, and industrial perspectives. The institution draws on a network of associate fellows, serving and former military officers, and government practitioners — producing commentary that is less theoretical than structural but grounded in institutional knowledge of how defense establishments actually function.

# Key Frameworks

## Cheap Attack, Expensive Defence

Andreas Urbanski (RUSI) argues that both the [US-Iran War]({{ site.baseurl }}/conflicts/us-iran-war-2026.html) and the [Russia-Ukraine War]({{ site.baseurl }}/conflicts/russia-ukraine-war.html) demonstrate the same structural lesson: cheap mass (drones, mines, swarming boats) defeats expensive platforms. Defending can cost a hundred times more than attacking. The 5% GDP defense pledge is historic, but the danger is that money flows into familiar platforms rather than innovative, low-cost, layered solutions. NATO can win every engagement and still lose wars if it does not invert the cost curve of air defense, build long-range strike at low unit cost, recapitalise mine countermeasures, and fund civilian resilience [1].

## Defence Spending ≠ Defence Capacity

Ian Ball, John Crompton, and Dag Detter (RUSI) argue that Britain's defense debate is dominated by inputs (spending as % of GDP) rather than outputs (capacity and readiness). A larger defense budget does not automatically produce more defense capability. They propose three reforms: a Defence Capacity Statement with every spending uplift (showing munitions output, drone production, ship repair, deployable units, training capacity, housing quality), Capacity Schedules for each service/Top Level Budget holder, and a Defence Capacity Map classifying assets, bottlenecks, and liabilities shaping readiness. Weak accounting is evidence of weak management visibility — if provisions for liabilities are understated, today's budget is flattered at the expense of tomorrow's force [2].

## The Spirit of Anchorage is Dead

RUSI traces the collapse of the "spirit of Anchorage" — the vague term Russian media adopted after the August 2025 Trump-Putin summit in Alaska, which had no formal written agreement behind it and whose death Lavrov pronounced by June 2026 — as illustrative of Russia's pattern of oscillating between hard doctrines and abstract, religiously-themed frameworks about its "destiny" that make international agreements difficult to negotiate or enforce [3]. See [Spirit of Anchorage 2025]({{ site.baseurl }}/events/spirit-of-anchorage-2025.html).

## Russia's Three Parallel Conversations

RUSI identifies three separate but parallel conversations Russia maintains: the Ukraine war, the bilateral US relationship, and potential future war with [NATO]({{ site.baseurl }}/actors/organizations/nato.html). The Kremlin sees no contradiction between sounding the alarm over imminent NATO war, continuing strikes on Kyiv, and criticizing the US while maintaining engagement with [Trump]({{ site.baseurl }}/actors/trump.html). Peskov's 6 July statement that the "special operation" had morphed into a "war" — echoed by [Lukashenka]({{ site.baseurl }}/actors/lukashenka.html) — marked a significant linguistic shift. War is not inevitable despite the alarmist framing [3].

## Russian Sanctions Price Cap Exhaustion

RUSI argues the G7 oil price cap is exhausted and unreliable. The US focus on Iran under maximum-pressure strategy undermined European efforts to constrain [Russian]({{ site.baseurl }}/actors/countries/russia.html) energy revenue. The US issued general licences allowing Russian oil sales during the Hormuz crisis (Brent surpassed $100/barrel), kneecapping G7 price cap efforts just as they were biting (Urals fell below $50/barrel by December 2025). Nearly 30% of Russian crude in April 2026 was transported on G7 tankers, particularly Greek-owned. RUSI recommends replacing the price cap with a full maritime services ban, expanding targeting of vessels and enabling networks, and tightening shadow fleet vessel acquisition [4].

## Beyond the Baltics: Risk Manipulation Strategy

RUSI argues European defence planning is too narrowly focused on a single Baltic "bite and hold" scenario and should consider the broader global strategic context. A Sino-American crisis or war would represent [Russia]({{ site.baseurl }}/actors/countries/russia.html)'s "last window" to revise the European order — but Russia's best options might be ensuring a Chinese victory in the Pacific rather than directly attacking Europe. Russian officers (Sterlin, Gerasimov) describe regional war as escalating rapidly and decided primarily in the rear — making theatre-wide capabilities (deep strike, IAMD, attack submarines) more important than local force balances. The proposed strategy: "risk manipulation" — convince Russia that a regional war would be unpredictable and leave it strategically worse off. Missile inventories are far cheaper than armoured brigades (220 Tomahawks for ~$833M vs. ~$600M/year for one armoured brigade). Much of Russia's industrial base lies within several hundred kilometres of Finland and [Ukraine]({{ site.baseurl }}/actors/countries/ukraine.html) [6].
...
- 2026-07 (RUSI, "NATO Planning for War with Russia") [3] — called the "spirit of Anchorage" framework as hollow, with no formal written agreement behind it, predicting it would not hold. **Hit.** Lavrov pronounced it dead by June 2026, confirming the diagnosis. The call was structural — the absence of any written agreement meant the framework depended entirely on rhetorical momentum, which was inherently time-limited.
- 2026-07 (Jim McLean, "Putin's Fuel Dilemma") [10] — predicted Ukraine's deep-strike campaign against Russian energy infrastructure would create a sustained fiscal squeeze reaching ordinary Russians. **Hit.** Putin's 28 June 2026 public acknowledgment of fuel "problems" and a "certain shortage" confirmed the prediction, with quantified evidence: the fuel dampener rising from ~$220M in Q1 2026 to >$2.5B in May alone, gasoline production down ~25% since late May, retail fuel prices up 3% in a single week. The methodology — translating battlefield operations into fiscal indicators — proved sound.
- 2026-07 (RUSI, "The Future of Russian Sanctions After the Hormuz Crisis") [4] — called the G7 oil price cap as exhausted and unreliable, predicting US general licences during the Hormuz crisis would undermine European sanctions efforts. **Hit.** Urals fell below $50/barrel by December 2025, and by April 2026 nearly 30% of Russian crude was transported on G7 tankers (particularly Greek-owned), confirming the cap's collapse. The call correctly identified the structural tension between US Iran policy and Russia sanctions enforcement.

**Open**

- 2026-07 (Andreas Urbanski, "Cheap Attack, Expensive Defence") [1] — standing forecast that NATO's 5% GDP pledge will produce inadequate capacity if money flows into familiar platforms rather than low-cost, layered solutions (drone swarms, counter-drone, long-range strike at low unit cost, mine countermeasures, civilian resilience). Resolves on whether NATO procurement post-Ankara summit prioritizes innovative low-cost systems over legacy platforms (armoured brigades, exquisite air defense).
- 2026-07 (RUSI, "NATO Planning for War with Russia") [3] — standing forecast that NATO-Russia war is not inevitable despite alarmist framing, and that Russia maintains three parallel conversations (Ukraine, bilateral US, future NATO war) without contradiction. Resolves on whether Russia's behavior continues to decouple the three tracks or whether one track escalates into direct NATO conflict.
- 2026-07 (RUSI, "Thinking Beyond the Baltics") [6] — standing forecast that Russia's "last window" to revise the European order would be better exploited by ensuring a Chinese victory in the Pacific than by directly attacking Europe, and that "risk manipulation" (convincing Russia a regional war would be unpredictable and strategically costly) is the optimal deterrent. Resolves on whether NATO adopts theatre-wide capabilities (deep strike, IAMD, attack submarines) over local Baltic force balances, and whether Russia's behavior in a Sino-American crisis follows the Pacific-first logic.
- 2026-07 (RUSI, "The AI-Enhanced Land Carrier Battle Group") [8] — standing forecast that drone carriers will become integral to land manoeuvre operations, addressing the attrition stalemate of drone-dominated battlefields. Resolves on whether any military adopts LCBG-type formations or equivalent UAS-centric combined arms structures.
- 2026-07 (Francisco Carneiro Júnior, "The Algorithmic Deterrent") [9] — standing forecast that the atomic age of deterrence is ending and an algorithmic age is beginning, with digital sovereignty becoming a core strategic concern. Resolves on whether more states adopt Switzerland-style sovereignty standards or remain "digital protectorates" dependent on foreign AI infrastructure.
- 2026-07 (Antonio Giustozzi, "The EU's pragmatic turn toward the Taliban") [11] — standing forecast that the Taliban hold the stronger negotiating position and that migration pressure will drive further normalization beyond consular transfer. Resolves on whether the EU proceeds toward formal recognition of the Taliban or reverses course.
- 2026-07 (James Brown, "Japan's Ambivalent Russia Policy") [12] — standing forecast that the structural LDP split will continue to produce ambivalent Russia policy under Takaichi. Resolves on whether Takaichi's government consolidates around either the Abe reengagement or Kishida alignment approach.
- 2026-07 (Jim McLean, "The Dismissal of Ukraine's Defence Minister") [13] — standing forecast that Ukrainian defence reforms (brigade consolidation, corps strengthening, technology-enabled casualty reduction) will continue despite Fedorov's removal, and that the conscription problem is training, personnel management, and corruption — not recruitment volume. Resolves on whether the Ukrainian military implements the three reform lines and whether conscription reform addresses quality over quantity.
- 2026-07 (Rachel Ellehuus, "The critical enablers of a more European NATO") [5] — standing forecast that a more European-led NATO requires delivering tangible results, Ukraine's centrality to credible European defence, and private sector engagement. Resolves on whether Ankara summit follow-through (Project Freya, NSDIF26, financing mechanisms like the Multilateral Defence Mechanism and Defence Security and Resilience Bank) produces measurable capability delivery.

**Single-publication-as-single-voice**

Per rules.md §8.5, "RUSI" is not one analytical voice. Track Record entries above are attributed to the individual contributor (Urbanski, McLean, Carneiro Júnior, Giustozzi, Brown, Ellehuus) where the byline is known. Entries without a named byline are marked "RUSI" and represent institutional or unattributed analysis; future entries should follow the same practice.

# Sources in Bundle

- "Cheap Attack, Expensive Defence: NATO 5% Pledge Following Iran and Ukraine" [1]
- "Defence Spending Must Become Defence Capacity" [2]
- "NATO Planning for War with Russia – but has Moscow Left the Door Open?" [3]
- "The Future of Russian Sanctions After the Hormuz Crisis" [4]
...
[1] [Cheap Attack, Expensive Defence: NATO 5% Pledge Following Iran and Ukraine](https://www.rusi.org/explore-our-research/publications/commentary/cheap-attack-expensive-defence-nato-5-pledge-following-iran-and-ukraine)

[2] [Defence Spending Must Become Defence Capacity](https://www.rusi.org/explore-our-research/publications/commentary/defence-spending-must-become-defence-capacity)

[3] [NATO Planning for War with Russia – but has Moscow Left the Door Open?](https://www.rusi.org/explore-our-research/publications/commentary/nato-planning-war-russia-has-moscow-left-door-open)

[4] [The Future of Russian Sanctions After the Hormuz Crisis](https://www.rusi.org/explore-our-research/publications/commentary/future-russian-sanctions-after-hormuz-crisis)

[5] [The critical enablers of a more European NATO](https://www.euractiv.com/opinion/the-critical-enablers-of-a-more-european-nato/)
