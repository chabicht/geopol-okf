...
France is a nuclear power, permanent member of the UN Security Council, and the leading military actor in the EU alongside [Germany]({{ site.baseurl }}/actors/countries/germany.html). France maintains significant interests in [Africa]({{ site.baseurl }}/regions/africa.html), the [Middle East]({{ site.baseurl }}/regions/middle-east.html), and the Indo-Pacific, where its overseas territories give it a direct strategic stake.

# Current Situation

## Taiwan Statement

Along with Britain and [Germany]({{ site.baseurl }}/actors/countries/germany.html), France issued a rare joint statement on [Taiwan]({{ site.baseurl }}/actors/countries/taiwan.html) through de facto embassies in Taipei. This collective European signal represents a significant shift — France and its partners are now treating Taiwan as integral to the global order, extending their strategic concern beyond the European theater into the [Indo-Pacific]({{ site.baseurl }}/regions/indo-pacific.html).

## Target of Russian Cognitive Warfare

France has been a direct target of Russian [cognitive warfare]({{ site.baseurl }}/themes/cognitive-warfare.html). The [pig head attacks]({{ site.baseurl }}/events/paris-pig-head-attack.html) on Paris mosques — islamophobic vandalism operations orchestrated by Russia's Social Design Agency — represent a deliberate effort to inflame domestic tensions. Election interference operations have further targeted French democratic processes. These are not random acts but coordinated campaigns designed to destabilize Western societies from within.
