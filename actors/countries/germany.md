...
Germany has published its first military strategy, though it reads more as analysis than operational instructions. The Bundeswehr's focus on the Russia threat is strategically sensible — it reflects a recognition that Europe must provide its own conventional defense within the NATO framework rather than relying indefinitely on American capabilities.

## Timeline Inconsistencies

The strategy contains a fundamental timeline inconsistency: defend by 2029, achieve full capabilities by 2035, and field the strongest conventional army by 2039. These staggered milestones raise questions about credibility and urgency. The gap between aspirational end-states and near-term readiness is stark.

## Three Fatal Flaws

The strategy suffers from three structural deficiencies: an inconsistent timeline, no operationalization of the technological and economic transformation required, and no structural changes to defense institutions. Without addressing these, the strategy risks remaining declaratory rather than transformative.

## Current Capability Gap

Germany is currently unable to fulfill its NATO obligations, particularly its role as a logistics hub for European defense. This is not a future problem — it is a present-day shortfall that undermines alliance readiness.

## Signal to Washington

The strategy signals to Washington that Europe is ready to shoulder the conventional defense burden, and that the Indo-Pacific and Middle East are not German priorities. This is a deliberate scoping decision that reflects both strategic realism and resource constraints.

## Taiwan

Along with [France]({{ site.baseurl }}/actors/countries/france.html) and Britain, Germany issued a rare joint statement on [Taiwan]({{ site.baseurl }}/actors/countries/taiwan.html) through de facto embassies in Taipei. This signals that European powers now treat Taiwan as integral to the global order — a position that extends German strategic concern beyond the European theater.
...
Germany is at the epicenter of what [Adam Tooze]({{ site.baseurl }}/actors/authors/adam-tooze.html) calls "China Shock 2.0" — the current wave of Chinese export competition that differs fundamentally from the early-2000s "China Shock 1.0." Germany's trade balance with [China]({{ site.baseurl }}/actors/countries/china.html) swung by €27 billion between 2021 and 2025, with 60% of that swing accounted for by vehicles. Chancellor Merz has taken up the accusation of an undervaluced Chinese currency. Volkswagen announced plans to cut up to 100,000 jobs, conveying the depth of the industrial crisis [6].
