...
The US-led international order is under simultaneous pressure from multiple theaters: an unresolved [Cold War 2]({{ site.baseurl }}/conflicts/cold-war-2.html) with the DragonBear axis of China and Russia, a [US-Iran War]({{ site.baseurl }}/conflicts/us-iran-war-2026.html) that exposed deep military and diplomatic weaknesses, and an accelerating [AI military race]({{ site.baseurl }}/themes/ai-military-race.html) where technological advantage has not yet translated into operational integration.
...
[The Honest Sorcerer]({{ site.baseurl }}/actors/authors/the-honest-sorcerer.html) debunks the "energy independence" narrative: the US is a net crude oil importer. NGLs are not oil and cannot make diesel or jet fuel. US refineries need heavy crude from Canada, Venezuela, and Saudi Arabia. During the Iran war, an armada of 121 empty tankers headed to the US to export refined fuels, draining the [SPR]({{ site.baseurl }}/events/spr-depletion-crisis.html) to approximately 349 million barrels — approaching 1983 lows. Post-peak shale is evident from declining rig counts [11].

## Diplomatic Erosion

The war accelerated an existing trend of diplomatic decline. The US alienated European allies, Japan, and South Korea. Gulf states increasingly view Washington as an unreliable security partner. The inability to maintain alliance cohesion during a major military campaign signals a structural weakening of the US-led coalition system.

## AI Race with China

The United States holds a 3-6 month lead in AI model development, but trails China by years in military integration. The policy environment is characterized by a vacuum: Congress and the executive branch operate with friction, and no coherent national strategy has emerged for closing the integration gap. Beijing's coordinated, national-level approach contrasts sharply with Washington's fragmented response.

The Director of National Intelligence faces a set of strategic decisions: refocusing the ODNI, resourcing the intelligence community for AI and space domains, and adapting Cold War-era institutions to contemporary great-power competition.
...
[Phillips O'Brien]({{ site.baseurl }}/actors/authors/phillips-obrien.html) warns that the Trump administration's plan to compile a master list of all foreign intelligence sources could be catastrophically destructive. The centralization of source identities in a single database creates an unprecedented counterintelligence liability — a breach or leak would compromise every foreign liaison relationship the US maintains. The plan serves no operational purpose other than to consolidate control over information that has historically been compartmented across agencies [15].
