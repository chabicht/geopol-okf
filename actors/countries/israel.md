...
Israel is the dominant military power in the eastern [Middle East]({{ site.baseurl }}/regions/middle-east.html) and a nuclear-armed state. Its security doctrine prioritizes preventing regional adversaries from acquiring capabilities that could threaten Israeli territory or population centers. The [US-Iran War of 2026]({{ site.baseurl }}/conflicts/us-iran-war-2026.html) was conducted in part on Israel's behalf, yet the outcome has left Jerusalem dissatisfied.
