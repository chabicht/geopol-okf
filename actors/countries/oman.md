...
## IRGC Strike on Duqm Port

[Phillips O'Brien]({{ site.baseurl }}/actors/authors/phillips-obrien.html) documents that the IRGC struck logistics and refueling facilities at the port of Duqm on July 12, 2026 — facilities used by US carrier operations. The strike on Duqm, Oman's deep-water port on the Arabian Sea, demonstrates that Iran's "sideways escalation" strategy extends to neutral mediators whose infrastructure supports US military logistics. The attack complicates Oman's mediating position by demonstrating that even a state with credibility in Tehran is not immune to Iranian strikes when it hosts US-supporting infrastructure [2]. See [US-Iran War of 2026]({{ site.baseurl }}/conflicts/us-iran-war-2026.html).
