...
CSIS estimates that Chinese EV industry subsidies totaled $231 billion from 2009 to 2023. Tooze notes that while this is large, it is not outsized compared to the European Green Deal or Biden's IRA — and German automakers paid out €31 billion in dividends in 2023 alone rather than reinvesting. The Chinese export surge is not driven by weak home demand in the affected sectors; it reflects structural industrial policy [9].

## Real Exchange Rate Depreciation and Capital Controls
...
China is extending its influence into [Bangladesh]({{ site.baseurl }}/actors/countries/bangladesh.html) through $9.2 billion in proposed investments across infrastructure, logistics, manufacturing, and energy. Prime Minister Tarique Rahman's visit to Beijing produced 13 MOUs and renewed momentum behind the Teesta River project — a long-delayed initiative that India and Bangladesh had been unable to agree on. The expansion alarms [India]({{ site.baseurl }}/actors/countries/india.html) but faces limits: Myanmar's instability, Bangladesh's desire for strategic autonomy, and Beijing's strained budget [14].

## CMC Purge

In February 2026, Xi Jinping purged the Central Military Commission, removing Zhang Youxia and Liu Zhenli — the only CMC members with combat experience. The purge was driven by disagreement over the [Taiwan]({{ site.baseurl }}/conflicts/taiwan-standoff.html) timeline: Xi insists on a 2027 invasion capability, while Zhang anticipated full joint operational capability closer to 2035. The purge damages command cohesion and reduces the likelihood of a near-term Taiwan invasion, while increasing the risk of miscalculation by new commanders eager to demonstrate loyalty. See [CMC Purge of 2026]({{ site.baseurl }}/events/cmc-purge-2026.html) [7].
