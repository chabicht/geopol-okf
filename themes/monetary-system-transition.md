...
- **Gulf states hedging**: The [UAE]({{ site.baseurl }}/actors/countries/uae.html) and [Saudi Arabia]({{ site.baseurl }}/actors/countries/saudi-arabia.html) are maintaining dollar pegs while simultaneously developing non-dollar trade channels — a hedging strategy that preserves optionality [1][2].
