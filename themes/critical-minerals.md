...
Rare earths occur in four primary deposit types, but by-product streams dwarf dedicated mines:

- **Carbonatite deposits** host the world's largest primary REE mines. China's Bayan Obo (100M+ tonnes reserves) produces rare earths as a by-product of iron ore. Mountain Pass (California) and Mount Weld (Australia, 14.8% TREO grade) are the major Western operations [7].
- **Ion-adsorption clays** in southern China supply the vast majority of heavy rare earths — grades of only 0.05-0.5% REO but 60-90% exchangeable content amenable to in-situ leaching. Myanmar has emerged as a controversial secondary source (31,000 tonnes in 2024) [7].
- **Placer deposits** (monazite/xenotime in mineral sands) represent massive resources — India alone holds 7.23M tonnes REO in monazite — but thorium content (6-12% ThO₂) has made processors reluctant [7].
- **By-product streams** contain quantities dwarfing dedicated mining: phosphogypsum stacks in Florida alone contain an estimated 200,000-500,000 tonnes of REEs in 1 billion tonnes of waste; global red mud (bauxite residue) contains 2-7 million tonnes; US coal ash inventory holds an estimated 11 million tonnes [7].

## Western By-Product Barriers

The gap between Western stockpiled REE potential and actual extraction traces to specific obstacles:

- **Phosphogypsum** faces an EPA ban (1989-1990) prohibiting use of material exceeding 10 pCi/g radium-226. Florida's phosphate ore exceeds this, locking away ~500,000 tonnes of rare earths. No active exemption applications are under review [7].
- **Red mud** processing technology exists (Rio Tinto/Geomega pilot achieving 64% scandium and 79% neodymium recovery) but economics don't close — silica gel formation, high iron co-dissolution, and sheer volumes prevent commercial-scale implementation [7].
- **Coal fly ash** offers favorable chemistry (Appalachian Basin ash at 591 ppm average) with DOE-funded projects achieving 98% REO concentrate, but processing costs of $50-1,200 per tonne of ash to recover only 550 grams of rare earths require high commodity prices [7].
- **Mineral sands** represent the Western success story: Iluka Resources' Eneabba operation in Western Australia has stockpiled 1M tonnes of monazite/xenotime concentrate (~$650M value), constructing Australia's first integrated rare earth refinery ($1.7-1.8B cost, $1.65B government loan, commissioning targeted 2027). Energy Fuels' White Mesa mill in Utah is the only US facility currently separating rare earths domestically [7].

## China's Environmental Devastation
...
The C5+1 critical minerals talks in Kazakhstan represent a Western attempt to develop alternative supply chains, but the competitive landscape is unfavorable. Western investment is constrained by sanctions risk, compliance requirements, and ESG standards that Chinese investment does not face. The result is that Central Asian states, despite concerns about Chinese dominance, are forced to interact with China as the dominant partner — approximately 90% of FDI in resource-rich states comes from China [1].
...
## Environmental Cost of the Energy Transition
