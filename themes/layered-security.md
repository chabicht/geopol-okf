...
The shift from rigid alliance blocs to layered security is not a departure from historical norms but a return to them. Bismarck managed German security through overlapping arrangements — the League of the Three Emperors linked Germany, Austria-Hungary, and Russia in a loose alignment that reduced incentives for conflict without binding any party to automatic military support. The goal was risk management, not wartime commitment. The Cold War's rigid alliance system was the anomaly, produced by the unique conditions of bipolarity and nuclear escalation risk.
