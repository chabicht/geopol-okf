...
Osborn and Warren argue that conservative voters do not see "saving democracy" as relevant to their political priorities because they perceive institutions as having drifted from the founding values that make democracy legitimate. The framing of democratic defense as institutional preservation misses the substance of the conservative critique — which is not anti-democratic but anti-institutional in the specific sense that the institutions no longer embody the values they claim to represent [1].

The central question, as they frame it, is not "Should America be a democracy?" but "Has American democracy remained faithful to what makes it legitimate?" The founding values — faith, family, freedom, place — are the basis on which conservative voters assess institutional legitimacy. When institutions are perceived as having forsaken these values, the appeal to "save" them is heard as a defense of the very drift that delegitimized them [1].

## Communism as Failed Ideology

Gliedman argues that communist governments are authoritarian by structural necessity — the seizure of private property required by communist doctrine cannot be achieved through voluntary compliance and therefore requires coercive state power. This authoritarian character is not a deviation from communist theory but an implementation of it. The historical record — Soviet Union, Mao's China, Cuba — confirms that communist governance leads to mass death, not as an accident but as a consequence of the concentration of power required to enforce collectivization [2].

The economic failure is equally structural: communist governments cannot run an economy because central planning cannot replicate the information-processing function of price signals in a market. The only nominally functioning communist states are those heavily subsidized by external patrons — Cuba by the Soviet Union and later Venezuela — which demonstrates that the system cannot sustain itself [2].

Polovynka extends the critique to theory itself: communism is bad even in theory. The Communist Manifesto contains fundamental logical flaws — the assumption that humans are angels who will work according to ability and receive according to need without incentive structures is not an empirical error but a category error about human nature [3].

## Latin American Realignment

[Velina Tchakarova]({{ site.baseurl }}/actors/authors/velina-tchakarova.html) argues that Latin America's rightward wave is converting ideological alignment into a hemispheric security bloc. The shift is significant because it represents a structural realignment rather than a cyclical swing — attitudes on crime and migration moved rightward independently of US political dynamics, meaning the realignment has indigenous roots [4].

However, the wave carries instability. Disputed elections, institutional weakness, and leftist strongholds in Mexico and Brazil mean that the realignment is not uniform or settled. The conversion of ideological shift into security bloc architecture depends on whether right-leaning governments can consolidate institutional control — and the historical record of [Latin America]({{ site.baseurl }}/regions/latin-america.html) suggests that this is not guaranteed [4].

## SCOTUS and Democratic Backsliding

[Paul Krugman]({{ site.baseurl }}/actors/authors/paul-krugman.html) argues that the [Slaughter SCOTUS ruling]({{ site.baseurl }}/events/slaughter-scotus-ruling.html) represents a judicial milestone in democratic backsliding — the Supreme Court overturning 90 years of precedent to grant [Trump]({{ site.baseurl }}/actors/trump.html) dictatorial power over regulatory agencies. The ruling is not about the presidency in general but about *this* president specifically: the Court is "utterly partisan," and Krugman expects it to strip discretionary power from any future Democratic president the moment one takes office [5].
...
[The Atlantic]({{ site.baseurl }}/actors/trump.html) (David Frum) documents how ICE has become less a law-enforcement agency than a content creator — producing videos of aggressive arrests set to pumping music for MAGA social media. ICE lowered training standards and ditched background vetting to meet deportation targets. The agency has killed four people since the crackdown began in June 2025, with 30+ incidents of agents opening fire or holding people at gunpoint. JD Vance's vociferous defense of the Minneapolis ICE shooting was planned, not spontaneous — reflecting the MAGA logic of redistributing respect away from overeducated coastal elites toward white Americans who feel left behind. The ICE agent who killed Renee Nicole Good is Trump's second-term Kyle Rittenhouse: enforcement of the MAGA vision of who must submit to whom [11].
