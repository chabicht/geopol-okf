...
- Russia is weaponizing property law to seize "ownerless" housing — homes whose Ukrainian owners fled — and redistribute them to Russian settlers [1].
- 75% of apartments in occupied Mariupol have been purchased by Russian immigrants [1].
- Russian government plans to resettle 114,000 Russians in occupied Ukraine by 2045 [1].
- Mechanisms include preferential mortgages for Russian buyers, employment incentives, free land for military veterans, and free economic zones [1].
- The campaign aims to engineer a demographic reality that entrenches occupation governance and complicates any future reintegration into Ukraine [1].

# Analysis

## Demographic Engineering as War Strategy

The resettlement campaign represents a deliberate effort to erase the Ukrainian character of occupied territories. By replacing displaced Ukrainians with Russian citizens — and by seizing their property through legal mechanisms — Russia is creating facts on the ground designed to make territorial return functionally impossible. The 75% Russian purchase rate in Mariupol demonstrates the campaign's effectiveness in areas longest under occupation.
...
[1] [Russia's Resettlement Strategy in Occupied Ukraine](https://understandingwar.org/research/russia-ukraine/russias-resettlement-strategy-in-occupied-ukraine/)
